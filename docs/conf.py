...
# -*- coding: utf-8 -*-
#
# SimpleQmap documentation build configuration file, created by
...
project = 'SimpleQmap'
copyright = '2013, Yasutaka Hanada'
...
#['goudy old style', 'minion pro', 'bell mt', "Georgia", 'Hiragino Mincho Pro', "serif"]
#html_theme = 'agogo'
#html_theme = 'mytheme'
...
latex_documents = [
  (master_doc, 'SimpleQmap.tex', 'SimpleQmap Documentation',
   'Yasutaka Hanada', 'manual'),
]
...
man_pages = [
    (master_doc, 'SimpleQmap', 'SimpleQmap Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'SimpleQmap', 'SimpleQmap Documentation',
   author, 'SimpleQmap', 'One line description of project.',
   'Miscellaneous'),
]
